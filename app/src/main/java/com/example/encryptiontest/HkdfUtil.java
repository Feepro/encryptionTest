...
public class HkdfUtil {
     ...
     */
    public static byte[] tlsCreateLabel(  byte[] label, byte[] context, int length ) {
        if ( context == null ) {
            context = new byte[]{};
        }
     ...
     */
    public static byte[] expandClientInLabel(  byte[] connectionId ) {
     ...
     * @return the expanded label
     */
    public static byte[] expandServerInLabel(  byte[] connectionId ) {
     ...
     * @return the expanded label
     */
    public static byte[] expandQuicKeyLabel(  byte[] connectionId ) {
     ...
     * @return the expanded label
     */
    public static byte[] expandQuicIvLabel(  byte[] connectionId ) {
        // see https://tools.ietf.org/html/draft-ietf-quic-tls-32#section-5.8 for reason for length
     ...
     * @return the expanded label
     */
    public static byte[] expandQuicHpLabel(  byte[] connectionId ) {
